...
const COURSE_URL = 'https://guyyfolkz.mbest.site/comunidade'
const WHATSAPP_COURSE_URL = 'https://wa.me/555193299031?text=Quero%20entrar%20no%20Curso%20Hermes%20%2B%206%20meses%20de%20comunidade'
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
            <a href={COURSE_URL}
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-sm transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(52,211,153,0.3)]">
              Entrar no Curso Hermes
            </a>
            <a href={WHATSAPP_COURSE_URL} target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl border border-zinc-700 text-zinc-300 hover:border-zinc-500 hover:text-white font-semibold text-sm transition-all">
              Fechar pelo WhatsApp
            </a>
          </div>

          <p className="mt-4 text-sm text-zinc-500 max-w-xl mx-auto">
            Curso pratico com prompts, repositorios GitHub e 6 meses de comunidade GuyFolkz incluidos.
          </p>
        </div>
        {/* Architecture */}
        ...
        <div className="mb-8 relative overflow-hidden rounded-2xl border border-amber-500/20 bg-gradient-to-br from-amber-500/8 via-orange-500/5 to-transparent p-8">
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-400 text-xs font-semibold mb-4">
              ...
              Curso Hermes + Comunidade
            </div>
            <h2 className="text-2xl font-bold text-white mb-3">
              Isto e so o que esta publico. A implementacao guiada esta no curso.
            </h2>
            <p className="text-zinc-400 mb-6 max-w-xl">
              No Curso Hermes voce recebe os <strong className="text-zinc-200">prompts completos</strong>,
              repositorios GitHub prontos, instalacao local ou VPS, configuracao de modelo, Telegram,
              memoria e 6 meses de comunidade GuyFolkz para continuar executando.
            </p>

            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
              {[
                { icon: '🧠', label: 'Prompts de instalacao' },
                { icon: '⚙️', label: 'GPT-5.5, OAuth e providers' },
                { icon: '📦', label: 'Repositorios prontos' },
                { icon: '🎬', label: 'Aulas e cases reais' },
              ].map(({ icon, label }) => (
